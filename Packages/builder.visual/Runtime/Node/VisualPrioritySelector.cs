...
namespace EntitiesBT.Builder.Visual
{
    ...
    public class VisualPrioritySelector : IVisualBuilderNode
    {
        ...
        public INodeDataBuilder GetBuilder(GraphInstance instance, GraphDefinition definition)
        {
            ...
            unsafe void BuildImpl(BlobBuilder blobBuilder, ref EntitiesBT.Nodes.PrioritySelectorNode data, INodeDataBuilder self, ITreeNode<INodeDataBuilder>[] builders)
            {
