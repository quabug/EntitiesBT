...
namespace EntitiesBT.Components.Odin
{
    ...
    public abstract class OdinNode : SerializedMonoBehaviour, INodeDataBuilder
    {
        ...
        public virtual IEnumerable<INodeDataBuilder> Children => this.Children<INodeDataBuilder>();
