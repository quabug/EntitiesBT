...
namespace EntitiesBT.Test
{
    public class TestNodeBlob : BehaviorTreeTestBase
    {
        ...
        //     builder.SetArray(ref builder.Value.Types, new[] { 11, 22, 33 });
        //     builder.SetTreeAny(ref builder.Value.Nodes, )
        //     
        ...
        public void should_generate_blob_from_nodes()
        {
            ...
            ref T GetDefaultData<T>(int nodeIndex) where T : unmanaged => ref blobRef.Value[nodeIndex].GetValue<T>();
        }
    }
}
